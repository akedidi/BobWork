---
name: nfr
description: "Define measurable and verifiable quality attributes."
icon: architecture
---

# NFR

Use this skill to define measurable and verifiable quality attributes.
...
1. Elicit performance, availability, security, privacy, accessibility, maintainability, and operability.
2. Formulate stimulus, context, response, and measure.
3. Set threshold, percentile, window, and load conditions.
4. Link NFRs to tests, observability, and capacity.

## Deliverable

Prioritized NFR catalog and quality scenarios.
...
- Avoid fast, scalable, or secure without a metric.
- Targets and limits are distinguished.
