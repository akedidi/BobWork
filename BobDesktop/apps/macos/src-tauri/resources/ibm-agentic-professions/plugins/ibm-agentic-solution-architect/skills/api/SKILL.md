---
name: api
description: "Design a coherent, secure, and evolvable API."
icon: architecture
---

# API

Use this skill to design a coherent, secure, and evolvable API.
...
1. Start from consumer capabilities and use cases.
2. Define resources/operations, schemas, errors, pagination, and idempotence.
3. Specify authn/authz, quotas, versioning, and compatibility.
4. Document in OpenAPI and test examples and contracts.

## Deliverable

OpenAPI contract, conventions, examples, and lifecycle strategy.
...
- Contract is valid and testable.
