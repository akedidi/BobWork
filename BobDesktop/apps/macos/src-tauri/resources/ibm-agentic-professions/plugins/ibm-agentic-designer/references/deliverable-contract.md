...
## Design IR (when designing UI)

Canonical source of truth before preview or `.sketch` export:
    ...
    "pages": [
      {
        ...
        "children": [
          { "id": "hero", "type": "Section", "children": [
            { "id": "title", "type": "Text", "text": "Headline" },
            { "id": "cta", "type": "Button", "text": "Primary action" }
          ]}
        ]
      }
    ]
...
Node `type` values must be PascalCase (`Page`, `Section`, `Text`, `Button`, …). Prefer Flex/Grid layout modes (`VERTICAL`, `HORIZONTAL`, `GRID`, `FREE`).
