...
description: "Measure capacity and willingness to succeed with the change."
icon: change
---

# change-readiness

Use this skill to measure capacity and willingness to succeed with the change.
...
1. Define dimensions: organization, leadership, culture, capacity, and technology.
2. Collect quantitative and qualitative evidence by segment.
3. Establish baseline, risk zones, and favorable factors.
4. Recommend launch conditions and interventions.

## Deliverable

Readiness assessment, heatmap, and go/no-go conditions.
...
- Readiness is not a single average score.
