...
fn register_runtime_requirements(
...
#[tauri::command]
pub async fn list_plugin_file_resources(
    plugin_id: String,
) -> Result<Vec<PluginFileResource>, AppError> {
    crate::services::plugin_user_resources::PluginUserResourceService::new().list_files(&plugin_id)
}

#[tauri::command]
pub async fn upload_plugin_file_resource(
    plugin_id: String,
    source_path: String,
) -> Result<PluginFileResource, AppError> {
    crate::services::plugin_user_resources::PluginUserResourceService::new()
        .upload(&plugin_id, &source_path)
}

#[tauri::command]
pub async fn delete_plugin_file_resource(
    plugin_id: String,
    file_id: String,
) -> Result<(), AppError> {
    crate::services::plugin_user_resources::PluginUserResourceService::new()
        .delete_file(&plugin_id, &file_id)
}

#[tauri::command]
pub async fn list_plugin_linked_databases(
    plugin_id: String,
) -> Result<Vec<PluginLinkedDatabase>, AppError> {
    crate::services::plugin_user_resources::PluginUserResourceService::new()
        .list_linked_databases(&plugin_id)
}

#[tauri::command]
pub async fn link_plugin_database(
    plugin_id: String,
    connection_id: String,
    name: String,
) -> Result<Vec<PluginLinkedDatabase>, AppError> {
    crate::services::plugin_user_resources::PluginUserResourceService::new().link_database(
        &plugin_id,
        &connection_id,
        &name,
    )
...
#[tauri::command]
pub async fn unlink_plugin_database(
    plugin_id: String,
    connection_id: String,
) -> Result<Vec<PluginLinkedDatabase>, AppError> {
    crate::services::plugin_user_resources::PluginUserResourceService::new()
        .unlink_database(&plugin_id, &connection_id)
}
