...
describe('ExtensionsView', () => {
  ...
  it('affiche tous les skills intégrés du plus récent au plus ancien', async () => {
  ...
  it('ouvre le skill demandé depuis un plugin', async () => {
    render(
      <MemoryRouter initialEntries={[{ pathname: '/skills', state: { skillSlug: 'analyse-contrats' } }]}>
        <ExtensionsView />
      </MemoryRouter>,
    )
