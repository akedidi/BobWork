      ...
      <div className="plugin-builder-body">
        ...
        {step === 'objectif' && (
          <section className="plugin-builder-panel">
            ...
            <p className="settings-note">
              ...
              , sans ces étapes. Dans le chat, Bob choisit et embarque lui-même les CLI open source.
            </p>
            <label>
              Nom
              <input
        ...
        {step === 'outils' && (
          <section className="plugin-builder-panel">
            ...
            <p>MCP, CLI, shell, binaires locaux, APIs — Bob peut les combiner. Pour un CLI open source, préférez le chat : Bob le télécharge et l’embarque lui-même, sans ces cases.</p>
              ...
              <label key={option.id} className="plugin-builder-choice">
                <input
                  ...
                  onChange={() => setDraft(current => {
                    ...
                    const permissions: PluginBuilderDraft['permissions'] =
                      needsExec && !current.permissions.includes('command.execute')
